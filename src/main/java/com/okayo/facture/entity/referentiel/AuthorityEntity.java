...
public class AuthorityEntity implements Auditable<String, Integer, LocalDateTime> {
    ...
    @JoinTable(name = "d_join_authority_right",
            joinColumns = @JoinColumn(name = "jar_ptr_autho_id"),
